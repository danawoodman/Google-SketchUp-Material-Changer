...
# Blog        : 
#
# Maintenance : Please report all bugs or strange behavior to...
#
# Version     : 
#
...
#
# To Install  : Place the SU_MaterialChanger.rb Ruby script in the 
...
file_loaded("SU_MaterialChanger.rb")
